...
def test_multiple_clients_with_different_configs():
    ...
    prod_client = BaseClient(base_url="https://engine.energytransitionmodel.com/api/v3")
    beta_client = BaseClient(base_url="https://beta.engine.energytransitionmodel.com/api/v3")
