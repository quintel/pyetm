...
class SessionLoader:
    ...
    def copy(
        ...
        try:
            ...
            logger.warning(
                "Failed to deep copy from Session '%s' for row '%s': %s",
                scenario_id,
                row_label,
                e,
            )
...
class SavedScenarioLoader:
    ...
    def copy(
        ...
        """Deep copy a SavedScenario and save the copy to MyETM."""
        from pyetm.models.saved_scenario import SavedScenario
        ...
        try:
            ...
            logger.warning(
                "Failed to deep copy from SavedScenario '%s' for row '%s': %s",
                scenario_id,
                row_label,
                e,
            )
